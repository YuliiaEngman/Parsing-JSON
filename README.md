...
JSON - JavaScript Object Notation. To review JSON is structured using one of two data structures, it can be structued using an array or a dictionary.
...
JSONLint
Quicktype - Convert JSON to Swift
Structures of JSON
JSON Cheatsheet
JSON.org
Working with JSON
